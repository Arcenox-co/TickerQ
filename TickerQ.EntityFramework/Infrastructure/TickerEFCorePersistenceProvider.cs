...
namespace TickerQ.EntityFrameworkCore.Infrastructure
{
        ...
        where TCronTicker : CronTicker, new()
    {
        ...
        public async Task<TCronTicker[]> RetrieveAllExistingInitializedCronTickers(CancellationToken cancellationToken = default)
        {
            var cronTickerContext = GetDbSet<CronTickerEntity>();
        ...
        public async Task<CronTickerOccurrence<TCronTicker>[]> RetrieveLockedCronTickerOccurences(string lockHolder, CancellationToken cancellationToken = default)
        {
            var cronTickerOccurrenceContext = GetDbSet<CronTickerOccurrenceEntity<CronTickerEntity>>();
        ...
        public async Task<TTimeTicker[]> RetrieveLockedTimeTickers(string lockHolder, CancellationToken cancellationToken = default)
        {
            var timeTickerContext = GetDbSet<TimeTickerEntity>();
        ...
        public async Task<CronTickerOccurrence<TCronTicker>[]> RetrieveNextCronTickerOccurences(string lockHolder, Guid[] cronTickerIds, CancellationToken cancellationToken = default)
        {
            var cronTickerOccurrenceContext = GetDbSet<CronTickerOccurrenceEntity<CronTickerEntity>>();
        ...
        public async Task<TCronTicker[]> RetrieveNextCronTickers(string[] expressions, CancellationToken cancellationToken = default)
        {
            var cronTickerContext = GetDbSet<CronTickerEntity>();
        ...
        public async Task<TTimeTicker[]> RetrieveNextTimeTickers(string lockHolder, DateTime roundedMinDate, CancellationToken cancellationToken = default)
        {
            var timeTickerContext = GetDbSet<TimeTickerEntity>();
        ...
        public async Task<CronTickerOccurrence<TCronTicker>[]> RetrieveQueuedNextCronOccurrences(Guid tickerId, CancellationToken cancellationToken = default)
        {
            var cronTickerOccurrenceContext = GetDbSet<CronTickerOccurrenceEntity<CronTickerEntity>>();
        ...
        public async Task<CronTickerOccurrence<TCronTicker>[]> RetrieveTimedOutCronTickerOccurrences(DateTime now, CancellationToken cancellationToken = default)
        {
            var cronTickerOccurrenceContext = GetDbSet<CronTickerOccurrenceEntity<CronTickerEntity>>();
        ...
        public async Task<TTimeTicker[]> RetrieveTimedOutTimeTickers(DateTime now, CancellationToken cancellationToken = default)
        {
            var timeTickerContext = GetDbSet<TimeTickerEntity>();
