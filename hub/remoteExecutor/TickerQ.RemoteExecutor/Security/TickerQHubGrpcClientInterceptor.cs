...
/// <summary>
/// Client-side gRPC interceptor for RemoteExecutor → Hub communication.
/// Adds API key/secret and HMAC signature to outgoing calls.
/// </summary>
internal sealed class TickerQHubGrpcClientInterceptor : Interceptor
{
    ...
    public TickerQHubGrpcClientInterceptor(TickerQRemoteExecutionOptions options)
    {
